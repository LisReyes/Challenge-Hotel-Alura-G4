...
public class ReservasView extends JFrame {
	 ...
	 */
	public ReservasView() {
		// Instanciamos la clase ReservasController
		...
		contentPane.setLayout(null);// Hace que las ventanas aprezcan siempre en medeio de la pantalla
		setResizable(false);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {				
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {
					guardarReserva();
					//RegistroHuesped registro = new RegistroHuesped(reservasController.);
		...
		lblNewLabel.setBounds(0, 11, 122, 14);
	...
	private void guardarReserva() {
		// transformamos los datos de fecha en String
		// Hacemos un Casteo
		...
		reservasController.createReserva(nuevaReserva);
	...
	// Nos encargamos de calcular el costo que pagara por los dias de estancia que tenga
	private void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		if(txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
			...
			valor = dias * diaria;
			String valorT = Integer.toString(valor);
			txtValor.setText("$" + valorT);
		}
	}
